...
public class SettingPlayerActivity extends BaseActivity {
    ...
    MaterialCardView mtvPlayer,aliangPlayer,builtinPlayer;
    SwitchCompat sw_highres;
    ArrayList<MaterialCardView> cardViewList;
    int checkPosition = -1;
    final String[] playerList = {"null","mtvPlayer","aliangPlayer","builtin"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builtinPlayer = findViewById(R.id.builtinPlayer);
        ...
        cardViewList.add(builtinPlayer);
