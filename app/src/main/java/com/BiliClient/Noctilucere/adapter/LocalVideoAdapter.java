...
import com.BiliClient.Noctilucere.activity.video.local.LocalPageChooseActivity;
import com.BiliClient.Noctilucere.api.PlayerApi;
import com.BiliClient.Noctilucere.listener.OnItemLongClickListener;
import com.BiliClient.Noctilucere.model.LocalVideo;
    ...
    public void onBindViewHolder(@NonNull LocalVideoHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            if(localVideo.videoFileList.size() == 1){
                try {
                    PlayerApi.jumpToPlayer(context, localVideo.videoFileList.get(0), localVideo.danmakuFileList.get(0), localVideo.title,true);
